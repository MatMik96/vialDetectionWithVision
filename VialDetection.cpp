 ...
 // Four corners of the plane in of the real world
        ...
        for (int i = 0; i < corners.size(); i++) {
            if (allPoints[i].x < meanXForAllPoints) {
                ...
                if (allPoints[i].y < meanYForAllPoints) {
        ...
        if (pts_dstInOrder.size() == 4) {
          ...
          // cv::imshow("homo", croppedImage);
            ...
            {
               // std::cout << "empty2 : " << croppedImage.size() << "\n";
                return croppedImage;
            }
        }
    }
    
   // std::cout << "empty3 : " << depthImage.size() << "\n";
    return depthImage;
